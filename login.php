...
<div class="nav-outer"> 
		...
		<ul class="select"><li><a href="adminlogin.php"><b>ADMIN</b></a></li></ul>
		
		<div class="nav-divider">&nbsp;</div>
		
		<ul  class="current"><li><a href="login.php"><b>USER</b></a>
		</li>
		</ul>
...
<div id="login-holder">
	...
	<div style="height: 55px"> <h1 style="padding-top: 20px; padding-left: 30px;"> CID Authentication</h1></div>
	<!--  start loginbox ................................................................................. -->
	<div id="loginbox">
...
elseif($retval==6)
{
	echo "<div id='message-green'><table border='0' width='100%' cellpadding='0' cellspacing='0'><tr><td class='green-left'>User registered 	successful <a href=''> lets Log In.</a></td><td class='green-right'><a class='close-green'><img src='images/table/icon_close_green.gif'   alt='' /></a></td></tr></table></div>";
}
...
<a href="register.php" class="forgot-pwdd">User signup ?</a>
 </div>
 <!--  end loginbox -->
