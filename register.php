...
<div class="nav-outer"> 
		...
		<ul class="current"><li><a href="index.php"><b>Home</b></a></li></ul>
...
<div id="page-heading"><h1>Cloud User Registration</h1></div>
...
<tr>
	...
	<td>
		...
		<tr>
			...
			<td><input type="text" class="inp-form" name="id" /></td>
			<td></td>
		</tr>
		<tr>
		...
		<td></td>
			...
			<div class="error-inner">Valid email id is required.</div>
		...
		<tr>
			...
			<td><input type="text"  name="mob" class="inp-form" /></td>
			<td>
